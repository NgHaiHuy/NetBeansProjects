...
@WebServlet(name = "calcuServlet_1", urlPatterns = {"/calcuServlet_1", "/calcuservlet_1", "/calcusevlet_1"})
public class calcuServlet_1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("        </div>");
            out.println("        <a href='calcu.html' class='btn-back'>Calculate Again</a>");
            out.println("    </div>");
            out.println("</body>");
            out.println("</html>");
        }
    ...
    public String getServletInfo() {
        return "calcuServlet_1 for HTML";
    }
}
